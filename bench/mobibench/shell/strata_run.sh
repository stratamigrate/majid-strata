...
export LD_LIBRARY_PATH=$STRATA/libfs/lib/nvml/src/nondebug/:$STRATA/libfs/build:$STRATA/libfs/src/storage/spdk/:$STRATA/shim/glibc-build/:$STRATA/libfs/lib/libspdk/libspdk/
